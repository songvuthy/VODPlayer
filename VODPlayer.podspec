...
Pod::Spec.new do |s|
  s.name             = 'VODPlayer'
  s.version          = '0.1.0'
  s.summary          = 'A short description of VODPlayer.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/32827363/VODPlayer'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { '32827363' => 'songvuthy93@gmail.com' }
  s.source           = { :git => 'https://github.com/32827363/VODPlayer.git', :tag => s.version.to_s }
